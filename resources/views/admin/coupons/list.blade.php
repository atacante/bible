...
{{--                                    <td>{!! $coupon->coupon_type !!}</td>--}}
                                    ...
                                    <td>{!! $coupon->amount !!}</td>
                                    <td class="text-center">{!! $coupon->expire_at?$coupon->expire_at->format('m/d/Y'):'-' !!}</td>
                                    <td class="text-center">{!! $coupon->uses_limit !!}</td>
                                    <td class="text-center">{!! $coupon->uses?$coupon->uses:0 !!}</td>
