...
{{--        {!! Form::label('date_from', 'Date') !!}--}}
        <div class="input-group input-daterange">
            {!! Form::text('view_date_from',Request::input('view_date_from'),['placeholder' => 'Date from','class' => 'form-control datepicker','style' => '']) !!}{{--mm/dd/yyyy--}}
            <span class="input-group-addon">to</span>
            {!! Form::text('view_date_to',Request::input('view_date_to'),['placeholder' => 'Date to','class' => 'form-control datepicker','style' => '']) !!}
        </div>
    </div>
{!! Form::token() !!}
    <div class="form-group">
