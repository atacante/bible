            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <div class="form-group{{ $errors->has('country_id') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('country_id', ViewHelper::getCountriesList(), old('country_id'), ['class' => 'form-control2 input1 j-select2','data-url'=> '/ajax/users-list','placeholder' => 'Select country...']) !!}
