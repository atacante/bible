...
@if($lexiconinfo->locations->count())
    <hr/>
    <div class="row">
        <div class="col-md-2 medium">LOCATIONS</div>
        <div class="col-md-10"><div class="text-left">
...
@if($lexiconinfo->peoples->count())
    <hr/>
    <div class="row">
        <div class="col-md-2 medium">PEOPLE</div>
        <div class="col-md-10"><div class="row col-md-12">
