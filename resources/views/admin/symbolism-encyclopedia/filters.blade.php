...
{!! Form::open(['method' => 'get','url' => '/admin/symbolism-encyclopedia/list']) !!}
...
{!! Html::link('/admin/symbolism-encyclopedia/list','Reset', ['class'=>'btn btn-danger pull-left reset-filter']) !!}
{!! Form::close() !!}
</div>