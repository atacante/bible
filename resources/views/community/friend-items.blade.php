            ...
            <div class="my-inner-friends-item">
                ...
                <div class="btns-group">
                    ...
                    @else
                        ...
                        <a href="{!! url('/user/cancel-friend-request/'.$people->id,[],false) !!}" class="btn2 cu2-btn1 j-cancel-friend-request {!! in_array($people->id,$myRequests) && !in_array($people->id,$myFriends)?'':'hidden' !!}"
                           data-toggle="modal"
                           data-target="#cancel-request-sm"
                           data-itemid="{!! $people->id !!}"
