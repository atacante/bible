...
{!! Form::open(['method' => 'get','url' => '/admin/reports/referred-users/'.$id,'class' => 'form-inline']) !!}
...
{!! Form::token() !!}
    <div class="form-group">
        ...
        {!! Html::link('/admin/reports/referred-users/'.$id,'Reset', ['class'=>'btn btn-danger pull-left reset-filter']) !!}
    </div>
{!! Form::close() !!}
</div>