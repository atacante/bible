...
{!! Form::open(['method' => 'get','url' => '/user/my-journey']) !!}
    <div class="form-group">
        ...
        {!! Form::select('types[]', ['note' => 'Notes','journal' => 'Journal','prayer' => 'Prayers'], Request::input('types'),['placeholder' => '','multiple' => true,'class' => 'clear-fix j-entry-types', 'style' => 'padding: 6px 12px;']) !!}
    </div>
    <div class="form-group">
