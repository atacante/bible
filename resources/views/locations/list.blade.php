                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                @foreach($location->images as $key => $image)
                                                    <div class="item {!! ($key == 0?'active':'') !!} j-with-images">
                                                        ...
                                                        <div class="location-image" data-image="{!! $image->image!=''?Config::get('app.locationImages').'thumbs/'.$image->image:'' !!}" style="background: url('{!! $image->image!=''?Config::get('app.locationImages').'thumbs/'.$image->image:'' !!}') center no-repeat;"></div>
                                                    </div>
                                                @endforeach
                                            </div>
