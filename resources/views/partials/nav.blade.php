        ...
        <ul class="main">
            ...
            <li class="with-items">
                ...
                <ul class="sub-nav">
                    ...
                    <li>
                        <a class="bs-lexicon"
                           href="{{ URL::to('/reader/verse?version=nasb&book=1&chapter=1&verse=1') }}"> Study Using Lexicon</a>
                    </li>
            ...
            @else
                    ...
                    <ul class="sub-nav">
                        ...
                        <li>
                            <a class="j-create-note" href="{{ url('/notes/create') }}">
                                <i class="bs-note"></i>Create Note </a>
                        </li>
                        <li>
                            <a class="j-create-journal" href="{{ url('/journal/create') }}">
                                <i class="bs-journal"></i>Create Journal Entry </a>
                        </li>
                        <li>
                            <a class="j-create-prayer" href="{{ url('/prayers/create') }}">
                                <i class="bs-pray"></i>Create Prayer </a>
                        </li>
                    </ul>
                </li>
                @endrole
                <li class="with-items log-pop">
                    <a href="#" class="cu-drop-menu-item">
                        ...
                        @endif
                        <span class="user-menu-name">{{ Auth::user()->name }}</span> </a>
...
<nav id="header" class="navbar navbar-default navbar-inner-pages">
    ...
    <div class="collapse navbar-collapse c-menu-home" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="drop1">
                    ...
                    <li>
                        <a href="{{ URL::to('/reader/read?version=nasb') }}"> <i class="bs-reader"></i>Read </a>
                    </li>
                    <li role="separator" class="divider"></li>
                    <li>
                    ...
                    @endif
                    <li>
                        <a href="{{ URL::to('/peoples/list') }}"> <i class="bs-people cu-bs-people"></i> People </a>
                    </li>
                    <li>
                        <a href="{{ URL::to('/locations/list') }}"> <i class="bs-places cu-bs-places"></i> Places </a>
                    </li>
                </ul>
            </li>
            {{-- --------------- EXPLORE --------------- --}}
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="drop1">
                    ...
                    @if(ViewHelper::checkPublished($data['cmsItems'],'bsc_events'))
                        <li>
                            <a href="{{ URL::to('/site/events') }}"> <i class="bs-calendar cu-nav-icons"></i> BSC Events
                            </a>
                        </li>
                    @endif
                    @if(ViewHelper::checkPublished($data['cmsItems'],'membership'))
                    ...
                    @if(    ViewHelper::checkPublished($data['cmsItems'],'recommended_resources')
                        ...
                        <li>
                            <a href="{{ URL::to('/blog?category='.$catId) }}">
                                <i class="bs-upload cu-bs-biblestudylogo" style="vertical-align: bottom;"></i> Recommended Resources
                            </a>
                        </li>
                    @endif
                    <li>
                        <a href="{{ URL::to('/shop') }}"> <i class="bs-gift cu-bs-gift"></i> Gift Shop </a>
                    </li>
                    {{--<li>
                        <a href="{{ URL::to('/blog') }}">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="drop1">
                    <div class="popup-arrow"></div>
                    <li>
                        <a href="{{ URL::to('/community') }}"> <i class="bs-publicwall"></i> Public Wall </a>
                    </li>
                    <li role="separator" class="divider"></li>
                    <li>
                        <a href="{{ URL::to('/groups') }}"> <i class="bs-s-groups"></i> Groups </a>
                    </li>
                    <li>
                        <a href="{{ URL::to('/community/find-friends') }}"> <i class="bs-friends"></i> Friends </a>
                    </li>
                    @if(    ViewHelper::checkPublished($data['cmsItems'],'recommended_resources')
                        && ($catId = ViewHelper::getBlogCatId('Recommended Resources'))
                    )
                        <li>
                            <a href="{{ URL::to('/blog?category='.$catId) }}"> <i class="bs-blog"></i> Blog </a>
                        </li>
                    @endif
                </ul>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            @if (Auth::guest())
                <li>
                    <a class="{{ (Request::is('auth/login') ? 'active' : '') }}" href="{{ URL::to('auth/login') }}">Login</a>
                </li>
                <li class=" bord-menu-item">
                    <a class="{{ (Request::is('auth/register') ? 'active' : '') }}" href="{{ URL::to('auth/register') }}">Sign Up</a>
                </li>
            @else
                ...
                <li class="dropdown log-pop">
                    <a href="#" class="dropdown-toggle cu-drop-menu-item" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        @else
                            <div class="user-default"></div>
                        @endif
                        <span title="{{ Auth::user()->name }}" class="user-neme-cut">{{ Auth::user()->name }}</span>
